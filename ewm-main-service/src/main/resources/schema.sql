DROP TABLE IF EXISTS users, locations, categories, events, requests, compilations, compilations_events, ratings;
...
CREATE TABLE IF NOT EXISTS ratings (
    ...
    CONSTRAINT ratings_p_key        PRIMARY KEY (id),
    CONSTRAINT ratings_event_fk     FOREIGN KEY (event)     REFERENCES events (id) ON DELETE CASCADE,
    CONSTRAINT ratings_initiator_fk FOREIGN KEY (initiator) REFERENCES users (id)  ON DELETE CASCADE,
    CONSTRAINT ratings_rater_fk     FOREIGN KEY (rater)     REFERENCES users (id)  ON DELETE CASCADE
);